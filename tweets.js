...
async function main(a,b = 15) {
  try {
    ...
    // Authentication
    let fileContents = fs.readFileSync('./data/conf.yml', 'utf8');
    ...
    await client.get('search/tweets', {q: a.concat(' lang:en'), result_type:'popular', count:b}, function(error, tweets, response) {  
